# Como contribuir com o Guia de Adonis
...
3. **Descrição de 1 linha** dizendo o que é e por que vale o clique (se for pago, diga isso na própria descrição).
...
1. Faça um fork e crie uma branch a partir da `main` (ex.: `feat/novo-curso-lucid`).
2. Edite o `README.md`.
